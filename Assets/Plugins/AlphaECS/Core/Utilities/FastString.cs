...
public class FastString
{
    ...
    ///<summary>Append a chararacter array without memory allocation</summary>
...
{
    public static FastString Append(this FastString fastString, char value, int repeatCount)
    {
